...
var app = (function () {
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			add_location(input, file, 8, 4, 73);
    		},
    ...
    class Lib extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*cepValue*/ ctx[0] === undefined && !("cepValue" in props)) {
    			console.warn("<Lib> was created without expected prop 'cepValue'");
    		}
    	}
    ...
    function create_cep_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 9, 4, 115);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 5, 0, 77);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(adressautocomplete, main, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ AdressAutocomplete: Lib });
    	return [];
    }
